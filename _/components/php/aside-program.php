<aside class="schedule">
	...
	<p>There's a lot happening at our many workshop and talks. Make sure you check out the <a href="program.php">full program</a> for more information</p>
	...
	<section class="accordion-group">
		...
		<div id="monday" class="accordion-body collapse">
			<section class="accordion-inner">
				...
				<p><a href="program.php#saturday" class="btn btn-danger btn-small">Saturday's Program</a></p>
	...
	<section class="accordion-group">
		...
		<div id="tuesday" class="accordion-body collapse">
			<section class="accordion-inner">
				...
				<p><a href="program.php#sunday" class="btn btn-danger btn-small">Sunday's Program</a></p>
	    </section><!-- accordion-inner -->
	  </div><!-- accordion-body -->
	</section><!-- accordion-group -->
