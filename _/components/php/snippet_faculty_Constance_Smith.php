<article id="Constance_Smith" class="media">
	...
	<img class="pull-left img-rounded" src="img/artists/Constance_Smith_tn.jpg" alt="Photo of Constance Smith">
	<div class="media-body">
		...
		<section class="modalphotos photogrid">
			<h3>Artwork</h3>
			<img src="img/artwork/Constance_Smith_01_tn.jpg" alt="Art from Constance Smith">
			<img src="img/artwork/Constance_Smith_02_tn.jpg" alt="Art from Constance Smith">
			<img src="img/artwork/Constance_Smith_03_tn.jpg" alt="Art from Constance Smith">
			<img src="img/artwork/Constance_Smith_04_tn.jpg" alt="Art from Constance Smith">
			<img src="img/artwork/Constance_Smith_05_tn.jpg" alt="Art from Constance Smith">
		</section>
	</div><!-- media body -->
</article>